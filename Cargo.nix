  ...
  internal = rec {
    ...
    crates = {
      ...
      "environment" = rec {
        ...
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./environment; };
      ...
      "repo" = rec {
        ...
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./repo; };
        dependencies = [
          {
            name = "derivative";
      ...
      "src" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./src; };
        dependencies = [
          {
            name = "anyhow";
            packageId = "anyhow";
